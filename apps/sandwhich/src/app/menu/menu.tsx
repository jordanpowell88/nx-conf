...
export function Menu(props: MenuProps) {
  ...
  return (
    <div className={styles['container']}>
      ...
      <MenuItem data-cy="pb" label='Peanut Butter' options={peanutButterOptions} valueChange={(pb) => peanutButterChange(pb as PeanutButterType)} />
      <MenuItem data-cy="jelly" label='Jelly' options={jellyOptions} valueChange={(j) => jellyChange(j as JellyFlavor)} />
